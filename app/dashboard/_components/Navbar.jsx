        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <img className="h-8 w-auto" src="/r.png" alt="Logo" />
            </a>
          </div>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            Upload photos of your rooms, and let RestNest's AI reimagine them into beautifully enhanced and optimized living spaces. Experience the future of home transformation with just a click!
            </p>
